...
fetch("../json/azkar.json")
  .then(res => res.json())
  .then(result => {
    for (let i = 0; i < result.evening_azkar.length; i++) {
      let cardDiv = document.createElement("div");
      let countDiv = document.createElement("div");
      let countText = document.createTextNode(result.evening_azkar[i].count);
      let contentDiv = document.createElement("div");
      let contentText = document.createTextNode(result.evening_azkar[i].content);
